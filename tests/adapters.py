...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.base_modules import scaled_dot_product_attention as sdpa
...
def run_rope(
    ...
    """
    from cs336_basics.base_modules import RotaryPositionalEmbedding as RoPE
...
def run_get_batch(
    ...
    """
    from cs336_basics.training_modules import loadBatch
    return loadBatch(dataset, batch_size, context_length, device)
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.training_modules import crossEntrophy
    return crossEntrophy(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.training_modules import gradClip
    gradClip(parameters, max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.training_modules import AdamW
    return AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.training_modules import cosLRS
    return cosLRS(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.training_modules import saveCheckPoint
    saveCheckPoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.training_modules import loadCheckPoint
    return loadCheckPoint(src, model, optimizer)
